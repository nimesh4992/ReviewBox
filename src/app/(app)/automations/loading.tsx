  ...
  return (
    <div className="min-w-0 animate-pulse">
      <div className="border-b border-[var(--rb-border-1)] px-6 py-5">
        ...
        <div className="mt-2 h-6 w-44 rounded bg-[var(--rb-bg-sunken)]" />
      </div>
      <div className="p-6 space-y-3">
        {/* Tab bar */}
        <div className="flex gap-4 border-b border-[var(--rb-border-1)] pb-3">
          <div className="h-4 w-20 rounded bg-[var(--rb-bg-sunken)]" />
          ...
          <div key={i} className="rounded-2xl border border-[var(--rb-border-1)] bg-surface p-5">
            <div className="flex justify-between items-center">
              <div className="space-y-2 flex-1">
                ...
                <div className="h-3 w-64 rounded bg-[var(--rb-bg-sunken)]" />
              </div>
              <div className="h-6 w-10 rounded-full bg-[var(--rb-bg-sunken)] ml-4" />
            </div>
          </div>
        ))}
      </div>
