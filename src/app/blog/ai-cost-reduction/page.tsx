    ...
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      <main className="mx-auto max-w-3xl px-6 pb-32">
        ...
        <div className="pt-10 pb-10">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 leading-snug">
        ...
        <div className="space-y-8 text-gray-700 text-[15px] leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10">The problem with naive AI</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10">Tier 1: 25 templates (0 tokens)</h2>
          <p>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 font-mono text-sm overflow-x-auto">
            <div className="text-gray-400 mb-3 font-sans text-xs font-semibold uppercase tracking-wider">Tag detection patterns</div>
            <pre className="text-gray-800 text-xs leading-relaxed">{`crash:    /crash|force.?close|stops.?working|keeps.?crashing/i
...
perf:     /slow|lag|freeze|hang|battery|drain|memory/i`}</pre>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10">Tier 2: Redis reply cache (0 tokens)</h2>
          <p>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 font-mono text-sm overflow-x-auto">
            <pre className="text-gray-800 text-xs leading-relaxed">{`key = "reply_cache:" + SHA256(text.slice(0,200) + rating + tone)
TTL = 604800  // 7 days`}</pre>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10">Tier 3: Compressed Groq prompt</h2>
          <p>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 text-sm text-gray-600">
            <p className="font-semibold text-gray-900 mb-2">Stripped phrases (sorted longest-first)</p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10">The full math</h2>

          <div className="overflow-x-auto rounded-2xl border border-gray-200 bg-white">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100">
                  <th className="px-5 py-3 text-left text-xs font-semibold text-gray-400">Metric</th>
                  <th className="px-5 py-3 text-center text-xs font-semibold text-gray-400">Before</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  ...
                  <tr key={label as string}>
                    ...
                    <td className="px-5 py-3 text-center text-gray-400">{before}</td>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10">What we gave up</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10">What&apos;s next</h2>
          <p>
        ...
        {/* Author */}
        <div className="mt-12 flex items-center gap-4 rounded-2xl border border-gray-200 bg-white p-6">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#0A84FF] text-lg font-bold text-white">
            R
          </div>
          <div>
            <p className="font-semibold text-gray-900">ReviewBox Engineering</p>
            <p className="text-sm text-gray-500">The team building ReviewBox.</p>
          </div>
        </div>
