...
const BENEFITS = [
  { emoji: "💰", label: "Competitive salary + equity" },
  { emoji: "🏥", label: "Full health, dental, vision (US)" },
  { emoji: "🌍", label: "Fully remote, async-first" },
  { emoji: "✈️", label: "2× annual team offsites" },
  { emoji: "📚", label: "$2K/year learning budget" },
  { emoji: "💻", label: "Top-of-the-line equipment" },
  { emoji: "🏖️", label: "Unlimited PTO (min 20 days)" },
        ...
        <div className="mb-16">
          ...
          <div className="space-y-4">
            {ROLES.map((role) => (
              <div
                key={role.title}
                className="rounded-2xl border border-gray-200 bg-white p-6 flex flex-col sm:flex-row sm:items-start sm:gap-6"
              >
