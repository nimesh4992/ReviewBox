        ...
        <Section className={RHYTHM.md}>
          <Reveal>
            <SectionHeading
              ...
              lede="Every plan syncs both stores, drafts AI replies in your brand voice, and publishes with one click. Pro adds the intelligence and collaboration layer — topic clustering, release health, Slack alerts, and multiple teammates. Only capabilities that work today: if a row is here, you can use it this afternoon."
            />
          </Reveal>
          ...
          <Section className={RHYTHM.md}>
            <Reveal>
              <SectionHeading
                ...
                lede={
                  <>
                    The questions people ask before they enter a card. More setup
                    and product questions live on the{" "}
                    <Link
                      href="/faq"
