...
export const metadata = {
  title: "Automation Rules â€” ReviewBox Help",
  description:
...
const RULE_EXAMPLES = [
  ...
  },
  {
    ...
    note: "Billing disputes always need a human â€” this keeps them from slipping.",
  },
  {
    name: "Handle short rating-only reviews",
    trigger: "Word count < 10",
    conditions: ["Rating is 4â˜… or 5â˜…"],
      ...
      <main className="mx-auto max-w-screen-xl px-6 pb-32">
        <div className="pt-10 pb-8 max-w-3xl">
          ...
          <p className="mt-3 text-gray-500 leading-relaxed">
            Automation rules let ReviewBox take actions automatically when new reviews arrive â€” without you clicking anything. Rules are available on all plans; auto-publish requires Team.
          </p>
        </div>
            ...
            <div id="how-rules-work" className="scroll-mt-24">
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-3">
                  {[
                    { label: "Trigger", desc: "A new review arrives, or an existing review is re-synced.", icon: "âš¡" },
                    { label: "Conditions", desc: "Filter by rating, sentiment, tags, version, country, word count.", icon: "ðŸŽ¯" },
                    { label: "Actions", desc: "Set priority, add tags, escalate, draft reply, auto-publish.", icon: "ðŸ¤–" },
                  ].map((item) => (
                ...
                <p className="mt-4 text-sm text-gray-600">
                  Rules are evaluated in order. The first matching rule wins â€” unless you enable <strong>Run all matching rules</strong> in Settings â†’ Automations.
                </p>
              </div>
            </div>
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6">
                <ol className="space-y-4 text-sm text-gray-600">
                  {[
                    ...
                    "Click **New rule**",
                    'Give your rule a name (e.g. â€œEscalate crash reportsâ€)',
                    'Set your **trigger** â€” usually â€œNew review receivedâ€',
                    "Add **conditions** to filter which reviews match",
                    "Choose one or more **actions** to perform",
                    "Click **Save** â€” the rule activates immediately",
                  ].map((step, i) => (
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <div className="mt-4 space-y-2 text-sm text-gray-600">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-600">
                    ...
                    <li>Auto-publish must be enabled in Settings â†’ Automations â†’ Allow auto-publish</li>
                  </ul>
                </div>
                <div className="mt-4 rounded-xl bg-amber-50 border border-amber-100 p-4">
                  <p className="text-sm text-amber-800">
                    <strong>Tip:</strong> Start with a narrow rule (e.g. 5â˜… + positive + short review) and monitor for a week before expanding. All auto-published replies appear in your audit log.
                  </p>
                </div>
              </div>
            </div>
