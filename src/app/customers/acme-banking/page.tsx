...
export const metadata = {
  title: "Acme Banking: 4.21 â†’ 4.58 in 90 Days â€” ReviewBox",
  description:
...
const METRICS = [
  { before: "4.21â˜…", after: "4.58â˜…", label: "App Store rating" },
      ...
      <main className="mx-auto max-w-4xl px-6 pb-32">
        ...
        <div className="pt-12 pb-10">
          <div className="flex flex-wrap items-center gap-3 mb-4">
            ...
            <span className="text-xs text-gray-400 dark:text-[#636366]">Fintech Â· Consumer Banking Â· 500K MAU</span>
          </div>
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-[#F5F5F7] sm:text-5xl leading-tight">
            4.21 â†’ 4.58 in 90 days.<br />No product changes.
          </h1>
          <p className="mt-5 text-lg text-gray-500 dark:text-[#86868B] leading-relaxed max-w-2xl">
            Acme Banking&apos;s mobile app had a ratings problem â€” not because the product was bad, but because they weren&apos;t responding to reviews. Here&apos;s exactly what changed.
          </p>
        </div>
        ...
        <div className="prose-container space-y-10 max-w-none">
          ...
          <section className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#161618] p-8">
            ...
            <p className="text-gray-600 dark:text-[#C7C7CC] leading-relaxed">
              Acme Banking&apos;s product team was small. Responding to app store reviews wasn&apos;t anyone&apos;s job â€” it fell between the cracks of support, product, and engineering. When a customer left a 1-star review about a failed transfer, nobody replied. When a user couldn&apos;t log in after an update, the review sat unanswered for weeks.
            </p>
            <p className="mt-4 text-gray-600 dark:text-[#C7C7CC] leading-relaxed">
              The app had a 4.21 rating on the App Store and a 4.18 on Google Play. Both had been trending down for three quarters. The team knew response rate was part of the problem â€” they just didn&apos;t have the bandwidth to fix it manually.
            </p>
            <div className="mt-6 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900/50 p-5">
              ...
              <ul className="text-sm text-red-800 dark:text-red-400 space-y-1 list-disc list-inside">
                ...
                <li>0 automation â€” every reply was manual</li>
              ...
              {[
                {
                  ...
                  body: "Any 5-star review with positive sentiment automatically gets an AI draft ready to send. The customer success team reviews and publishes in a batch each morning â€” 30 minutes instead of 3 hours.",
                },
                {
                  title: "Rule 2: Escalate crash reports to engineering",
                  body: "Reviews tagged with crash keywords at 1â€“2 stars are immediately escalated to the engineering channel on Slack. The team caught a login regression three days before their on-call rotation flagged it.",
                },
                {
          ...
          {/* Section 3 */}
          <section className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#161618] p-8">
            <h2 className="text-xl font-bold text-gray-900 dark:text-[#F5F5F7] mb-4">The results â€” 90 days later</h2>
            <p className="text-gray-600 dark:text-[#C7C7CC] leading-relaxed">
              The App Store rating moved from 4.21 to 4.58. Google Play went from 4.18 to 4.51. The product didn&apos;t change â€” the team shipped one minor update in that window. What changed was the signal the app stores received: replies went up, dwell time on negative reviews went down, and the recency-weighted rating improved steadily.
            </p>
            <p className="mt-4 text-gray-600 dark:text-[#C7C7CC] leading-relaxed">
              Reply rate jumped from 18% to 94%. The remaining 6% are reviews that require manual investigation (complex billing disputes, account-specific issues) â€” everything else is handled automatically or with a single click.
            </p>
            <blockquote className="mt-6 border-l-4 border-[#0A84FF] pl-6">
              <p className="text-gray-700 dark:text-[#C7C7CC] italic leading-relaxed">
                &ldquo;We changed nothing in the product â€” we just started actually responding to every review. Three months later our rating is the highest it&apos;s ever been.&rdquo;
              </p>
          ...
          <section className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#161618] p-8">
            ...
            <p className="text-gray-600 dark:text-[#C7C7CC] leading-relaxed">
              The team is now piloting auto-publish for 5-star template replies â€” the final step toward a fully automated positive-review pipeline. They&apos;re also using ReviewBox&apos;s sentiment trends to inform their quarterly roadmap: three features that previously had no voice are now tracked weekly from review sentiment data.
            </p>
          </section>
