      ...
      <main className="mx-auto max-w-4xl px-6 pb-32">
        ...
        <div className="pt-12 pb-10">
          <div className="flex flex-wrap items-center gap-3 mb-4">
            ...
            <span className="text-xs text-gray-400">Fintech · Consumer Banking · 500K MAU</span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 mb-14">
          {METRICS.map(({ before, after, label }) => (
            <div key={label} className="rounded-2xl border border-gray-200 bg-white p-5 text-center">
              <div className="text-xs text-gray-400 mb-2">{label}</div>
              <div className="flex items-center justify-center gap-2">
                <span className="text-sm text-gray-400 line-through">{before}</span>
                <span className="text-gray-300">→</span>
                <span className="text-xl font-bold text-gray-900">{after}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="prose-container space-y-10 max-w-none">
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-8">
            ...
            <div className="mt-6 rounded-xl bg-red-50 border border-red-100 p-5">
              <p className="text-sm font-semibold text-red-900 mb-1">Before ReviewBox</p>
          ...
          {/* Section 2 */}
          <section className="rounded-2xl border border-gray-200 bg-white p-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4">The setup</h2>
            <p className="text-gray-600 leading-relaxed">
            ...
            <div className="mt-6 space-y-4">
              {[
                ...
                <div key={rule.title} className="rounded-xl border border-gray-100 bg-gray-50 p-5">
                  <p className="font-semibold text-gray-900 text-sm">{rule.title}</p>
                  <p className="mt-2 text-sm text-gray-600 leading-relaxed">{rule.body}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          {/* Section 3 */}
          <section className="rounded-2xl border border-gray-200 bg-white p-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4">The results — 90 days later</h2>
            <p className="text-gray-600 leading-relaxed">
            ...
            <blockquote className="mt-6 border-l-4 border-[#0A84FF] pl-6">
              ...
              <footer className="mt-3">
                ...
                <p className="text-xs text-gray-400">Head of Mobile, Acme Banking</p>
              </footer>
            </blockquote>
          </section>
