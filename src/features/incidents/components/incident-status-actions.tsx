  ...
  return (
    <div className="flex flex-wrap items-center gap-2 pt-1">
      <Button
        ...
        className="h-8 border-[var(--rb-border-3)] text-fg-1 hover:bg-[var(--rb-amber-500)]/10 hover:border-[var(--rb-amber-500)]/40 hover:text-[var(--rb-amber-500)] disabled:opacity-40"
      >
        Mark Investigating
      </Button>
      <Button
        ...
        className="h-8 border-[var(--rb-border-3)] text-fg-1 hover:bg-[var(--rb-green-500)]/10 hover:border-[var(--rb-green-500)]/40 hover:text-[var(--rb-green-500)] disabled:opacity-40"
      >
        Mark Resolved
      </Button>
    </div>
